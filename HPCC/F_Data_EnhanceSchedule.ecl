...
//Present device ID with total Hard Acceleration
...
withMovingAveTypeAccelerationSummaryByDeviceChart := Visualizer.MultiD.Column('withMovingAveTypeAccelerationSummaryByDeviceChart', /*datasource*/, 'withMovingAveTypeAccelerationSummaryByDevice', withMovingAveTypeAccelerationSummaryByDeviceMappings, /*filteredBy*/, /*dermatologyProperties*/ );
//Present device ID with total times(hour)
...
withMovingAveTypeAccelerationSummaryByDeviceChart2 := Visualizer.MultiD.Column('withMovingAveTypeAccelerationSummaryByDeviceChart2', /*datasource*/, 'withMovingAveTypeAccelerationSummaryByDevice', withMovingAveTypeAccelerationSummaryByDeviceMappings2, /*filteredBy*/, /*dermatologyProperties*/ );
//Present device ID with average Hard Acceleration per hour
...
withMovingAveTypeAccelerationSummaryByDeviceChart3 := Visualizer.MultiD.Column('withMovingAveTypeAccelerationSummaryByDeviceChart3', /*datasource*/, 'withMovingAveTypeAccelerationSummaryByDevice', withMovingAveTypeAccelerationSummaryByDeviceMappings3, /*filteredBy*/, /*dermatologyProperties*/ );
//Present device ID with average Hard Brake per hour
...
withMovingAveTypeAccelerationSummaryByDeviceChart4 := Visualizer.MultiD.Column('withMovingAveTypeAccelerationSummaryByDeviceChart4', /*datasource*/, 'withMovingAveTypeAccelerationSummaryByDevice', withMovingAveTypeAccelerationSummaryByDeviceMappings4, /*filteredBy*/, /*dermatologyProperties*/ );
...
start_build_process := ORDERED(
                                withMovingAveTypeAccelerationSummaryByDeviceChart;
                                withMovingAveTypeAccelerationSummaryByDeviceChart2;
                                withMovingAveTypeAccelerationSummaryByDeviceChart3;
                                withMovingAveTypeAccelerationSummaryByDeviceChart4
                                  );

start_build_process : WHEN ( CRON ( '0-59/10 * * * *' ) ); //SCHEDULE A JOB every 5 minute